    ...
    public class FiDaDatabase : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserHost>(entity =>
            {
                ...
                entity.Property(u => u.AppKey).IsRequired(false);
                entity.Property(u => u.AppSecret).IsRequired(false);
                entity.Property(u => u.TokenExpiration).IsRequired(false);
            });
        }
        ...
        public DbSet<UserHost> UserHost => Set<UserHost>();
    }
}
